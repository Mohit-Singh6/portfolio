...
export default function MohitSinghInit () {
    return (
        <div className="flex flex-col mt-60 w-full mr-250">
            ...
            <SplitText
                text="MOHIT"
                className="font-heading text-8xl md:text-6xl text-white text-center h-22 pt-4 ml-15"
                delay={50}
                duration={1.25}
                ease="power3.out"
                splitType="chars"
            ...
            <SplitText
                text="SINGH"
                className="font-heading text-8xl md:text-6xl text-center h-22 pt-4 pl-18 ml-25"
                delay={50}
                duration={1.25}
                ease="power3.out"
                splitType="chars"
            ...
            <div className="flex gap-4 mt-8 justify-center ml-80">
                ...
                <button className="group/work relative overflow-hidden rounded-full border border-zinc-700/80 bg-transparent px-12 py-3 text-base transition-all duration-300 hover:border-[#2a8fb8] hover:shadow-[2px_2px_10px_rgba(42,143,184,0.35)] cursor-pointer">
