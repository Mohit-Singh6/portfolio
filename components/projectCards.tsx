...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <div
      ref={container}
      className="h-screen flex items-center justify-center sticky top-0 w-250 mr-10"
    >
      <motion.div
        style={{
          scale,
        ...
        <div className="flex flex-col justify-between w-full md:w-[45%] h-full z-10 pr-0 md:pr-8 pb-6 md:pb-0">
          ...
          <div className="pt-4">
            <a
              ...
              className="inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-white/5 text-white text-sm font-medium hover:bg-white hover:text-black transition-all duration-100 group/btn border border-white/10 hover:border-transparent shadow-lg"
            >
              See project
              <svg
                width="16"
